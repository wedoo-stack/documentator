               ...
               <div class="row justify-content-center">
                   <div class="col-12 text-center">
                     <div class="section-title text-center mb-4 pb-2">
                         <h4 class="mb-4">Επιλέξτε άρθρα</h4>
                   ...
                   <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                       <div class="card features explore-feature p-4 px-md-3 border-0 rounded-md shadow text-center">
                           <div class="card-body p-0 content">
                               <h5 class="mt-4"><a href="σδφσδ" class="title text-dark">σδφσδ</a></h5>
                               <p class="text-muted">δσφσδφσδ</p>

                               <a href="/book/δσφσδ" class="text-primary">Περισσότερα <i data-feather="chevron-right" class="fea icon-sm"></i></a>
                           </div>
                       </div>
                   </div><!--end col-->
